import "./desktopInterfaceDeleteAccountButton.css";
...
export default function DesktopInterfaceDeleteAccountButton() {
    ...
    return (
        <div className="desktopInterfaceDeleteAccountButton">

import "./desktopInterfaceUserProfileSettingsChangeAvatar.css";
...
export default function DesktopInterfaceUserProfileSettingsChangeAvatar() {
    ...
    return (
        <>
            <div className="desktopInterfaceUserProfileSettingsChangeAvatar">
